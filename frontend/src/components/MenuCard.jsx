    ...
    >
      ...
      <div className="h-56 w-full overflow-hidden relative">
        ...
        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-300 flex items-center justify-center">
          <span className="opacity-0 group-hover:opacity-100 text-white font-bold bg-indigo-600/90 px-4 py-2 rounded-full text-sm transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 shadow-lg backdrop-blur-sm border border-white/20">
            View Details
          </span>
        </div>
      </div>
