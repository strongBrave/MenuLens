         ...
         <div className="p-4 pb-2">
            ...
            <div className="flex flex-col gap-3 mb-4 px-1">
               ...
               <div className="grid grid-cols-2 gap-3">
                ...
                {/* API Model Settings Button */}
                <div className="col-span-2">
                  <button
                    onClick={() => setShowSettingsModal(true)}
                    className="w-full flex items-center justify-center gap-2 py-2.5 bg-violet-50 border border-violet-200 text-violet-700 text-xs font-bold rounded-xl hover:bg-violet-100 transition-colors"
                  >
