  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
              ...
              {messages.map((msg, idx) => (
                ...
                >
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${
                    msg.role === 'assistant' ? 'bg-brand-100 text-brand-600' : 'bg-slate-200 text-slate-600'
                  }`}>
      ...
      <motion.button
        ...
        className="w-14 h-14 bg-brand-600 hover:bg-brand-700 text-white rounded-full shadow-xl flex items-center justify-center transition-colors relative"
      >
