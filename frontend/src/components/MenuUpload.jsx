  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      ...
      >
        ...
        <div className={`absolute -inset-0.5 bg-gradient-to-r from-brand-500 to-pink-500 rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200 ${dragActive ? 'opacity-60' : ''}`}></div>
        ...
        <div className="relative bg-white/80 backdrop-blur-xl rounded-xl border border-white/50 shadow-xl p-12 text-center overflow-hidden">
            ...
            {/* Icon Circle */}
            <div className="mx-auto w-20 h-20 bg-brand-50 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-inner">
            ...
            <button
              ...
              disabled={disabled}
              className="px-8 py-3 bg-gradient-to-r from-brand-600 to-indigo-700 text-white rounded-full font-semibold shadow-lg shadow-brand-200 hover:shadow-brand-300 hover:-translate-y-0.5 transition-all active:scale-95"
            >
              {disabled ? (
